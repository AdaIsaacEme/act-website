...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-color)' }}>
      {/* CTA Strip - Hidden on mining and projects pages */}
      {!hideCTA && (
        <ScrollReveal direction="up" delay={0.1} className="py-8 px-4 text-center" style={{ backgroundColor: '#00A8E8' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t" style={{ borderColor: 'var(--border-color)', paddingTop: '1rem', paddingBottom: '1rem', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '10px' }}>
