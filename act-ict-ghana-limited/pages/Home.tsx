    ...
    <div style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 min-h-[300px] sm:min-h-[400px] md:min-h-[500px]">
          ...
          >
            <div
              className="flex items-center px-6 sm:px-8 md:px-16 py-12 sm:py-16 md:py-20 order-1 md:order-2"
              style={{ backgroundColor: "var(--bg-primary)" }}
            >
              <div>
                <h2
                  className="font-display text-4xl sm:text-5xl md:text-6xl mt-2 mb-4 sm:mb-6"
                ...
                >
                  Radio & mission-critical IT and Communications, network
                  infrastructure, intelligent CCTV, and security systems.
                </p>
                <div
        ...
        <div className="grid md:grid-cols-2 min-h-[300px] sm:min-h-[400px] md:min-h-[500px]">
          <ScrollReveal direction="left" delay={0} duration={0.6} distance={40}>
            <div
              className="flex items-center px-6 sm:px-8 md:px-16 py-12 sm:py-16 md:py-20"
            ...
            >
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  Industrial equipment, safety systems, and specialized
                ...
                >
                  ...
                  <p>✓ Mine Safety Solutions Management</p>
                  <p>✓ Intrusion Detection</p>
                  <p>✓ Technology Supply Integration</p>
                </div>
                <AnimatedLink
                  to="/act-global"
        ...
        >
          {recentProjects.map((project) => (
            ...
            >
              ...
              <h3
                className="font-display text-xl group-hover:text-[#00A8E8] transition-all duration-300"
                style={{ color: "var(--text-heading)" }}
              >
                {project.title}
              </h3>
