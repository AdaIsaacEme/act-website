          ...
          <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
              ...
              >
                ...
                <button
                  type="submit"
                  className="md:col-span-2 bg-green-600 text-white px-4 py-2 rounded font-bold flex items-center justify-center gap-2 hover:bg-green-700"
                >
              ...
              <table className="w-full text-left border-collapse">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="p-4 text-sm font-bold text-gray-600 text-right">
                      Actions
                    </th>
                  </tr>
                </thead>
          ...
          <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p className="text-gray-500">
                Global site configuration (Colors, SEO, Contact Info) would go
                here in a real production environment.
              </p>
            </div>
          </div>
        )}
